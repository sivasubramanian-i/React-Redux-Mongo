...
const mapDispatchToProps = dispatch => {
  return {
    checkUserUniqueness: userInputDetails =>
      dispatch(checkUserUniqueness(userInputDetails)),
    userSignupRequest: userSignupDetails =>
      dispatch(userSignupRequest(userSignupDetails))
  };
};
